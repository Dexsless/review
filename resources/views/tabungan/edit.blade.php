                ...
                <div class="card-body">
                    <form action="{{route('tabungan.update', $tabungan->id)}}" method="post">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" value="{{$tabungan->jumlah}}" class="form-control @error('jumlah') is-invalid @enderror"
                                name="jumlah">
                            @error('jumlah')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="date" value="{{$tabungan->tanggal}}" class="form-control @error('tanggal') is-invalid @enderror"
                                name="tanggal">
                            @error('tanggal')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
